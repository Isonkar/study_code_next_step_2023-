...
Количество строк в ответе должно совпадать с количеством слов в исходном тексте. Между закодированными буквами нужно ставится ровно один пробел. 
Например, слово «Help» превратится в «.... . .-.. .--.». Обратите внимание, что строчные и заглавные буквы кодируются одинаково.
...
for i in range(len(words)):
    if morze.get(words[i]) != None:
        print(morze.get(words[i]), end=' ')
    else:
        print()
        
 #  вариант два
[print(*[morze[j] for j in i.lower()]) for i in input().split()]
