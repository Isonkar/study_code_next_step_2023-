...
Он уже будет определен и заполнен данными, поэтому никакого ввода значений в это программе делать не нужно, просто обращаетесь к переменной data
...
for i in range(data['my_friends']['count']):
    friends_names.append(data['my_friends']['people'][i]['first_name'])
